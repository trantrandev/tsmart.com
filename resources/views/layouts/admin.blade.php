                ...
                <div class="main-friend-cont scroll-div">
                    <div class="main-friend-list">
                        <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe">
                            <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('') }}admin/images/user/avatar-1.jpg" alt="Generic placeholder image ">
                        ...
                        <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe">
                            <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('') }}admin/images/user/avatar-2.jpg" alt="Generic placeholder image">
                        ...
                        <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice">
                            <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('') }}admin/images/user/avatar-3.jpg" alt="Generic placeholder image"></a>
                            <div class="media-body">
                        ...
                        <div class="media userlist-box" data-id="5" data-status="offline" data-username="Suzen">
                            <a class="media-left" href="#!"><img class="media-object img-radius" src="{{ asset('') }}admin/images/user/avatar-4.jpg" alt="Generic placeholder image"></a>
                            <div class="media-body">
                ...
                <div class="main-chat-cont scroll-div">
                    <div class="main-friend-chat">
                        <div class="media chat-messages">
                            <a class="media-left photo-table" href="#!"><img class="media-object img-radius img-radius m-t-5" src="{{ asset('') }}admin/images/user/avatar-2.jpg" alt="Generic placeholder image"></a>
...
<!--[if lt IE 11]>
    ...
    <![endif]-->
        ...
        <script src="{{ asset('admin/js/pages/dashboard-ecommerce.js') }}"></script>
    </body>
    </html>

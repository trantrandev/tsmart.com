                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block ">
                                    {!! Form::open(['method' => 'POST', 'url' => 'admin/page/update/'.$page->id]) !!}
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('slug', $page->slug, ['class' => 'form-control', 'placeholder' => 'Slug input']) !!}
                                            @error('slug')
                                            <span class="text-danger d-block mt-1"
                                                  style="font-size: 13px">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('detail', $page->detail, ['class' => 'form-control', 'placeholder' => 'detail input']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="status" id="status" class="form-control">
                                                ...
                                                <option
                                                    value="inactive" {{ $page->status == 'inactive'?'selected':'' }}>
                                                    Không hoạt động
                                                </option>
                                            </select>
                                            @error('status')
                                    ...
                                    {!! Form::submit('Update', ['class' => ['btn', 'btn-primary', 'btn-sm', 'mb-0'], 'name' => 'btn_update']) !!}

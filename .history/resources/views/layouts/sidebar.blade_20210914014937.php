    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content scroll-div">
            ...
            <li class="nav-item pcoded-hasmenu {{ Request::segment(2)=='user'?'pcoded-trigger active':null }}">
                ...
                <ul class="pcoded-submenu">
                    <li class="{{ Route::is('list_user')?'active':null }}"><a href="{{ url('admin/user/list') }}" class="">List user</a></li>
                    <li class="{{ Route::is('add_user')?'active':null }}"><a href="{{ url('admin/user/add') }}" class="">Add user</a></li>
                </ul>
            </li>
            <li class="nav-item pcoded-hasmenu">

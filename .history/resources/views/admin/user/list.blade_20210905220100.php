					...
					<div class="col-sm-12">
						<div class="card">
							<div class="card-header pb-0 border-0">
								<h5>List user</h5>
								<a href="http://localhost/tsmartpro/admin/user/add" type="button" class="btn btn-primary waves-effect waves-light float-right d-inline-block md-trigger" data-modal="modal-13"> <i class="feather icon-plus m-r-5"></i> Add User
								</a>
							</div>
							<div class="card-block pb-0 pt-0">
								...
								<div class="form-action form-inline pt-3">
									...
									<input type="submit" name="btn-search" value="Áp dụng" class="btn btn-sm btn-primary m-0">

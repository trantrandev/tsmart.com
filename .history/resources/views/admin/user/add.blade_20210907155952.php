                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::select('status', ['Select gender','active' =>'active', 'inactive'=>'inactive'], '', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('address', '', ['form-control']) !!}
                                            <textarea name="address" id="address" class="form-control"  rows="auto" ></textarea>
                                        </div>
                                    </div>
                                    {!! Form::close() !!}
                                </div>

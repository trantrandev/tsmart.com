                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="main clearfix">
                                <div class="column">
                                    <button class="btn btn-primary md-trigger" data-modal="modal-1">Fade in &amp;
                                        Scale</button>
                                    <button class="btn btn-primary md-trigger" data-modal="modal-2">Slide in
                                        (right)</button>
                                    <button class="btn btn-primary md-trigger" data-modal="modal-3">Slide in
                                        (bottom)</button>
                                    ...
                                    <button class="btn btn-primary md-trigger" data-modal="modal-8">3D Flip
                                        (horizontal)</button>
                                    <button class="btn btn-primary md-trigger" data-modal="modal-9">3D Flip
                                        (vertical)</button>
                                    ...
                                    <button class="btn btn-primary md-trigger" data-modal="modal-14">3D Rotate
                                        Bottom</button>
                                    <button class="btn btn-primary md-trigger" data-modal="modal-15">3D Rotate In
                                        Left</button>
                                    <button class="btn btn-primary md-trigger" data-modal="modal-16">Blur</button>
                                    <button class="btn btn-primary md-trigger md-setperspective" data-modal="modal-17">Let
                                        me in</button>
                                    <button class="btn btn-primary md-trigger md-setperspective" data-modal="modal-18">Make
                                        way!</button>
                                    <button class="btn btn-primary md-trigger md-setperspective" data-modal="modal-19">Slip
                                        from top</button>
                                </div>
                            </div>
                            <div class="md-modal md-effect-7" id="modal-7">
                                <div class="md-content">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><strong>Read:</strong> modal windows will probably tell you something
                                                important so don't forget to read what they say.</li>
                                            <li><strong>Look:</strong> a modal window enjoys a certain kind of attention;
                                                just look at it and appreciate its presence.</li>

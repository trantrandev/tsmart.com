                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::password('confirm', ['class' => 'form-control', 'placeholder' => 'Password confirm', 'name' => 'confirm_password']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="custom-file-input" accept="image/*" id="up-avatar"
                                                name="avatar">
                                            <label class="custom-file-label" for="avatar" style="margin: 0 15px">Chọn file</label>
                                            <img src="{{ asset('admin/images/user/150.png') }}" class="mt-2" style="max-width: 150px;" id="up-img" alt="up-img">
                                        </div>
                                    </div>

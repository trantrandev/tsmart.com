                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form id="form-add-user" method="post" action="/" novalidate="">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Confirm Password <span class="text-danger" style="font-size:12px">(*)</span></label>
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control" id="repeat-password" name="repeat-password" placeholder="Confirm Password" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">

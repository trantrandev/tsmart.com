                    ...
                    success: function(response) {
                        if (response.status == "true") {
                            ...
                            var table = $('table').DataTable({
                                ajax: "{{ route('change_status_user') }}",
                                columns: [
                                    {'data': "avatar", name: response.data.avatar},
                                    {'data': "name", name: response.data.name},
                                    {'data': "email", name: response.data.email},
                                    {'data': "created_at", name: response.data.created_at},
                                    {'data': "status", name: response.data.status}
                                ]
                            });
                            table.ajax.reload();

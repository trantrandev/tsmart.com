                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('phone', '', ['class' => 'form-control', 'placeholder' => 'Phone input', 'data-mask' => '9999-999-999']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-2">
...
@section('add_js')
    ...
    <script src="admin/plugins/inputmask/js/jquery.inputmask.min.js"></script>
    <script src="admin/plugins/inputmask/js/autoNumeric.js"></script>
    <script src="admin/js/pages/form-masking-custom.js"></script>
@endsection

                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::file('avatar', ['id' => 'up-avatar', 'accept' => 'image/*', 'class' => 'custom-file-input']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file mb-3">
                                            <input type="file" class="custom-file-input" accept="image/*" id="up-avatar"
                                                name="avatar">
                                            <l/>abel class="custom-file-label" for="avatar">Chọn file</label>
                                        </div>
                                        <img src="http://localhost/project_tsmart/public/img/150.png"
                                            style="max-width: 150px;" id="up-img" alt="">
                                    </div>
                                    {{-- button submit --}}
                                    <div class="form-group row">

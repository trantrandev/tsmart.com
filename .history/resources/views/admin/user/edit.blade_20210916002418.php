                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    {!! Form::open(['METHOD' => 'POST', 'url' => 'admin/user/update', 'files' => 'TRUE']) !!}
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" {{ old('gender') == 'male'?'checked':'' }}  type="radio" name="gender" id="male"
                                                        value="male"> Male
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" {{ old('gender') == 'female'?'checked':'' }} type="radio" name="gender" id="female"
                                                        value="female"> Female
                                                </label>
                                            </div>
                                            @error('gender')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::submit('Update user', ['class' => ['btn', 'btn-primary', 'btn-sm'], 'name' => 'btn_update']) !!}

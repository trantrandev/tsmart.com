                             ...
                             <div class="card Online-Order">
                                 <div class="card-block">
                                     ...
                                     <h6 class="text-muted d-flex align-items-center justify-content-between m-t-30">
                                         Delivery Orders<span class="float-right f-18 text-c-green">237 / 400</span></h6>
                             ...
                             <div class="card Online-Order">
                                 <div class="card-block">
                                     ...
                                     <h6 class="text-muted d-flex align-items-center justify-content-between m-t-30">Pending
                                         Orders<span class="float-right f-18 text-c-purple">100 / 500</span></h6>
                                     <div class="progress mt-3">
                             ...
                             <div class="card Online-Order">
                                 <div class="card-block">
                                     ...
                                     <h6 class="text-muted d-flex align-items-center justify-content-between m-t-30">Return
                                         Orders<span class="float-right f-18 text-c-blue">50 / 400</span></h6>
                                     <div class="progress mt-3">
                             ...
                             <div class="card theme-bg2">
                                 <div class="card-block">
                                     <div class="row align-items-center justify-content-center">
                                         <div class="col-auto">
                                             <img src="{{ asset('') }}admin/images/widget/shape5.png"
                                                 alt="activity-user">
                                         </div>
                                         <div class="col">
 ...
 @section('add_js')
     ...
     <script src="{{ asset('admin/plugins/amchart/js/worldLow.js') }}"></script>w

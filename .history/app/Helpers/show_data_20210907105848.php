...
if(!function_exists('show_status_user')) {
	function show_status_user($status) {
		$array_data = array(
			...
			<a class="btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
			...
			'inactive' =>
			'<div class="status dropdown action-label">
			<a class="btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">

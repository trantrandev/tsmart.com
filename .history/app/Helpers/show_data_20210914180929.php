...
if (!function_exists('show_status_user_current')) {
    function show_status_user_current($id) {
            ...
            <input type="checkbox" id="switch-s-' . $id . '" checked data-checked="Active" data-unchecked="Inactive" disabled>
...
if (!function_exists('show_status_user')) {
    function show_status_user($status, $id)
    {
        $array_data = array(
            ...
            <input type="checkbox" id="switch-s-' . $id . '" checked data-checked="Active" data-unchecked="Inactive">
            <label for="switch-s-' . $id . '" class="cr"></label>
            </div>',
            'inactive' =>
            '<div class="switch switch-success d-inline m-r-10">
            <input type="checkbox" id="switch-s-' . $id . '" data-checked="Active" data-unchecked="Inactive">
            <label for="switch-s-' . $id . '" class="cr"></label>
            </div>'

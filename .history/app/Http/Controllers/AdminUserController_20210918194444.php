...
class AdminUserController extends Controller
{
    ...
    function change_status(Request $request)
    {
        ...
        return response()->json(['status' => 'true', 'count' => $count, 'users' => $users]);
    }
    ...
    function index()
    {
        ...
        return DataTables::of($users)
            // Thêm cột stt
            ->addIndexColumn()
            // Thêm html cho avatar
            ->editColumn('avatar', function ($user) {
                if ($user->avatar != null) {
                    return '<td class="abd"><img class="bcd" style="width: 50px"

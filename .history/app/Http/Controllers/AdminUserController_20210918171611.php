...
class AdminUserController extends Controller
{
    ...
    function change_status(Request $request)
    {
        ...
        foreach ($users as $user) {
            ...
            // $html .= '<td class="status>'.Auth::id() == $user->id?show_status_user_current($user->id):show_status_user($user->status, $user->id).'</td>';
            $html .= '</tr>';
        }

        return response()->json(['status' => 'true', 'count' => $count, 'data' => $users, 'html' => $html]);
    }
